...
router.patch('/providers/:providerId/status', validateRequiredFields(['status']), updateProviderStatus);
...
router.post('/create-support-admin', requireSuperAdmin, validateRequiredFields(['name', 'email']), createSupportAdmin);
